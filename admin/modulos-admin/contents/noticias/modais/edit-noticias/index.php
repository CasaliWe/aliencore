<div class="modal fade" id="modal-editar-noticias" tabindex="-1" aria-labelledby="modal-editar-noticias" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= $base_url ?>modulos-admin/contents/noticias/php/editar-noticia.php" method="post" enctype="multipart/form-data">
          <div class="modal-body">

          <input type="hidden" id="id-projeto-editar" name="id-projeto-editar">
          
            <div class='mb-3'>
              <label class="small" for='titulo-projeto-editar'>Título notícia*</label>
              <input type='text' id='titulo-projeto-editar' name='titulo-projeto-editar' class='form-control' required>
            </div>

            <div class='mb-3'>
              <label class="small" for='descricao-projeto-editar'>Descrição notícia*</label>
              <input type='text' id='descricao-projeto-editar' name='descricao-projeto-editar' class='form-control' required>
            </div>

            <div class='mb-3'>
              <label class="small" for='link-projeto-editar'>Data notícia*</label>
              <input type='text' id='link-projeto-editar' name='link-projeto-editar' class='form-control' required>
            </div>

            <div class='mb-3'>
              <label class="small" for='img-projeto-editar'>Imagem notícia*</label>
