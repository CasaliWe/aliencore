            ...
            <?php foreach ($integrantes as $key => $projeto) { ?>
                <div class="my-3 py-3 px-3 border-bottom border-top">
                    <div class="row">
                        ...
                        <div class="align-self-center col-2"> <div class="_container-img-projeto"> <img src="<?= $base_url ?>assets/imagens/arquivos/integrantes/<?= $projeto['imagem']; ?>" alt="<?= $projeto['titulo']; ?>"> </div> </div>
                        <div class="align-self-center justify-content-end col-2 d-flex">
                            ...
                            <form action="<?= $base_url; ?>modulos-admin/contents/integrantes/php/excluir-projeto.php" method="post">
